     ...
     var $uploads;
        ...
        function file_uploader($errors, $post, $files){
            ...
            foreach($files as $key => $val):
                ...
                $allowed_types = empty($field['allowed_file_types']) ? get_option('aol_allowed_file_types') : $field['allowed_file_types'];
                ...
                if( strstr($allowed_types, $file_ext) == FALSE ) $errors->add('file_type', sprintf(__( 'Invalid file %1$s. Allowed file types are %2$s', 'ApplyOnline' ), $val['name'], $allowed_types));
        ...
        public function aol_process_app_form(){
            ...
            if($pid > 0){
                ...
                $message = str_replace('[id]', $pid, get_option_fixed('aol_application_message') );

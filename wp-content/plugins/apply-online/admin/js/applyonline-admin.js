                ...
                if(fieldNameRaw == '' || fieldType == '' || fieldID == '' || fieldID == '_aol_app_'){
                    ...
                    switch (select_value){
                        ...
                        case 'radio':
                          ...
                          break;
                        case 'file':
                          output = start_html+help_html+class_html+file_html+required_html+end_html;
                          break;
                        case 'separator':
...
function aol_form(element, fieldID = null, fieldNameRaw = null, fieldPlaceholder = null, fieldDesccription = null, fieldClass = null, fieldFileTypes = null, checked_item = null, fieldOptions = null, aol_defult_selection = null, fieldType = null, required = null){
    ...
    var array = {
        ...
        types      : '<div><label>Classes</label><input '+fieldName+'[allowed_file_types]" value="'+fieldFileTypes+'" type="text"></div>',

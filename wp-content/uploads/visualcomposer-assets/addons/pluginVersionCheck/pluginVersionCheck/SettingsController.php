                    ...
                    if (is_array($jsonData)) {
                        if (version_compare($jsonData['version'], $this->requiredVersion, '>=')) {
                            ...
                            $noticeHelper->addNotice(
                                ...
                                sprintf(
                                    __(
                                        'You have an outdated Visual Composer Website Builder plugin version which does not support the new activation flow. Please update your plugin to enjoy all the new features and performance. <a href="%s">Update</a>',
                                        'visualcomposer'
                                    ),
